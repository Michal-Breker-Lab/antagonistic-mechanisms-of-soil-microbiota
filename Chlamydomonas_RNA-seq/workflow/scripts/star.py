...
transcriptome_bam = snakemake.output.get("transcriptome_bam", "")
if transcriptome_bam:
    transcriptome_bam = "--quantMode TranscriptomeSAM"
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    if snakemake.output.get("transcriptome_bam"):
        shell("cat {tmpdir}/Aligned.toTranscriptome.out.bam > {snakemake.output.transcriptome_bam:q}")
